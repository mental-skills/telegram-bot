...
Telegram-бот и Mini App Mental Skills — образовательный тренажёр решений для родителей юных футболистов. Подключены семь согласованных футбольных ситуаций.
...
- Каталог сценариев с полным порядком прохождения: ситуация №1 → №2 → №3 → №4 → №5 → №6 → №7.
...
- Отдельный запуск каждой ситуации без смешивания с полным маршрутом.
...
- `TELEGRAM_BOT_USERNAME` — username обычного Telegram-бота;
...
- Подключены все семь согласованных ситуаций и итоговый экран полного маршрута.
- CRM, оплаты, генеративного ИИ и административной панели нет.
- Отдельный протокол безопасности ситуации №6 требует клинической и юридической проверки перед production-публикацией.
